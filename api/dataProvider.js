...
var petroviser = {
                ...
                body:
                {
                    ...
                    Options:
                    {
                        OverrideEntitySet:
                        {
                            ...
                            Entities: [{ Name: wellId, EntityTypeName: 'Well' }]
                        },
            ...
            request.post({
                ...
                function (error, response, body) {
                    if (!error && response.statusCode == 200) {
                        ...
                        if (flag === oilWellDetails.data.petroData[3].Data[0].Data.length) {
    ...
    getOilWellDetailsByWellID: function(req, res, next) {
        console.log(req.query);
        var getData={
             peer:req.query.peer,
           fcn:"GetOilWellDetailsByWellID",
           args:'[\"'+req.params.oilWellId+'\"]'
         };
         console.log("---"+JSON.stringify(getData));
        request.get({
             uri: fabricURL + '/channels/'+'mychannel'+'/chaincodes/'+'OilWellDetailsCC?'+require('querystring').stringify(getData),
